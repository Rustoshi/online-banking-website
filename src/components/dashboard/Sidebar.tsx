          ...
          <div className="px-4 py-4">
            <div className="rounded-xl p-4" style={{ backgroundColor: '#1a2332' }}>
              <div className="flex items-center mb-3">
                <div className="flex-shrink-0 mr-3">
                  {user?.profilePhoto ? (
                    ...
                    <div className="h-10 w-10 rounded-full bg-cyan-500 flex items-center justify-center text-white font-bold border-2 border-cyan-400">
              ...
              <div className="flex space-x-2">
                ...
                <button
                  onClick={logout}
                  className="flex-1 inline-flex justify-center items-center px-2.5 py-1.5 border border-transparent shadow-sm text-xs font-medium rounded text-white bg-cyan-600 hover:bg-cyan-700"
                >
