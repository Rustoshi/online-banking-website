      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-[var(--text-muted)]">Account Balance</p>
              <p className="text-xl font-semibold text-[var(--text-primary)]">{formatCurrency(user.balance)}</p>
            </div>
          </div>
        </Card>
        <Card>
      ...
      <Card>
        ...
        <div className="divide-y divide-[var(--border)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 py-3">
            ...
            <span className="md:col-span-2 font-mono font-medium">{user.pin || '****'}</span>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 py-3">
