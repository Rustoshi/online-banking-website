              ...
              <button
                ...
                className={`p-4 rounded-lg border text-left transition-all ${
                  emailType === type.value
                    ...
                    : 'border-[var(--border)] hover:border-cyan-300 hover:bg-[var(--bg)]'
                }`}
              >
                <Icon className={`w-6 h-6 ${emailType === type.value ? 'text-cyan-600' : 'text-[var(--text-muted)]'}`} />
                <p className={`mt-2 text-sm font-medium ${emailType === type.value ? 'text-cyan-700' : 'text-[var(--text-primary)]'}`}>
                  {type.label}
                </p>
...
• Support team signature"
              rows={10}
              className="w-full px-3 py-2 bg-[var(--surface)] border border-[var(--border)] rounded-lg text-sm text-[var(--text-primary)] placeholder:text-[var(--text-muted)] focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-opacity-30 focus:border-cyan-500"
            />
          </div>
