  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen bg-[var(--public-bg)]">
        ...
        {/* Hero Section */}
        <section className="relative pt-32 pb-20 bg-gradient-to-br from-cyan-900 via-teal-800 to-slate-900">
          <div className="absolute inset-0 bg-[url('/images/hero.jpg')] bg-cover bg-center opacity-10" />
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-500/20 border border-cyan-500/30 rounded-full text-cyan-400 text-sm font-medium mb-6">
            ...
            <Link
              href="/register"
              className="inline-flex items-center justify-center px-8 py-4 bg-cyan-500 text-white font-semibold rounded-xl hover:bg-cyan-600 transition-all"
            >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {mortgageTypes.map((mortgage, index) => (
                ...
                >
                  <Home className="w-10 h-10 text-cyan-500 mb-4" />
                  <h3 className="text-lg font-semibold text-[var(--public-text-primary)] mb-2">{mortgage.title}</h3>
                  <p className="text-cyan-500 font-semibold mb-2">{mortgage.rate}</p>
        ...
        <section className="py-20 bg-cyan-600">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <Link
              href="/register"
              className="inline-flex items-center justify-center px-8 py-4 bg-white text-cyan-600 font-semibold rounded-xl hover:bg-cyan-50 transition-all"
            >
