  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden print:shadow-none">
        {/* Receipt Header */}
        <div className="relative bg-gradient-to-r from-cyan-600 to-cyan-700 px-6 py-8 text-white">
              ...
              <div className="divide-y divide-gray-200">
                ...
                <div className="p-4 bg-gray-50">
                  <div className="flex justify-between items-center">
                    ...
                    <p className="text-lg font-bold text-cyan-700">{currencySymbol}{formatCurrency(transaction.balanceAfter)}</p>
                  </div>
                </div>
              </div>
            </div>
