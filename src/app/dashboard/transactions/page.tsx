      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        ...
        <div className="flex mt-4 md:mt-0 space-x-3">
          ...
          <button
            ...
            className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-cyan-600 hover:bg-cyan-700 transition-colors"
          >
      ...
      <form onSubmit={handleSearch} className="mb-6">
        <div className="relative">
          ...
          <input
            ...
            className="block w-full pl-10 pr-3 py-3 border border-gray-700 rounded-lg bg-gray-800 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all"
                    ...
                    <tr key={transaction._id} className="hover:bg-gray-700/50 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <Link
                          ...
                          className="inline-flex items-center px-2 py-1 text-xs font-medium rounded text-cyan-400 hover:text-cyan-300 hover:bg-cyan-500/10 transition-colors"
                        >
          ...
          <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center">
            ...
            <div className="relative inline-block w-full max-w-md p-6 my-8 text-left align-middle bg-gray-800 rounded-xl shadow-xl transform transition-all border border-gray-700">
              ...
              <div className="text-center mb-6">
                <div className="mx-auto flex items-center justify-center h-14 w-14 rounded-full bg-cyan-500/20 mb-4">
                  <Filter className="h-7 w-7 text-cyan-400" />
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      ...
                      <input
                        ...
                        className="block w-full border border-gray-600 rounded-lg p-2.5 bg-gray-700 text-white focus:ring-cyan-500 focus:border-cyan-500"
                      />
                    </div>
                    <div>
              ...
              <div className="mt-6 flex justify-end space-x-3">
                ...
                <button
                  ...
                  className="px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-cyan-600 hover:bg-cyan-700"
                >
                  Apply Filters
                </button>
              </div>
            ...
            <div className="relative inline-block w-full max-w-md p-6 my-8 text-left align-middle bg-gray-800 rounded-xl shadow-xl transform transition-all border border-gray-700">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select className="block w-full border border-gray-600 rounded-lg p-2.5 bg-gray-700 text-white focus:ring-cyan-500 focus:border-cyan-500">
              ...
              <div className="mt-6">
                <button className="w-full px-4 py-2.5 border border-transparent text-sm font-medium rounded-lg text-white bg-cyan-600 hover:bg-cyan-700 inline-flex items-center justify-center">
