  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] p-4 md:p-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        ...
        <Link href="/dashboard/loans/apply" className="mt-4 md:mt-0 inline-flex items-center px-4 py-2 rounded-lg bg-cyan-600 hover:bg-cyan-700 text-white font-medium transition-colors">
      ...
      <div className="bg-[#111111] rounded-xl border border-gray-800 overflow-hidden">
        ...
        {loans.length > 0 ? (
              ...
              <tbody className="divide-y divide-gray-800">
                {loans.map((loan) => (
                  <tr key={loan._id} className="hover:bg-[#1a1a1a] transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <Link href={`/dashboard/loans/${loan._id}`} className="text-cyan-400 hover:text-cyan-300 text-sm">
                        View
                      </Link>
                    </td>
                  </tr>
          ...
          <div className="p-12 text-center">
            ...
            <Link href="/dashboard/loans/apply" className="mt-4 inline-flex items-center px-4 py-2 rounded-lg bg-cyan-600 hover:bg-cyan-700 text-white font-medium transition-colors">
              <Plus className="h-4 w-4 mr-2" /> Apply for Loan
            </Link>
          </div>
        )}
