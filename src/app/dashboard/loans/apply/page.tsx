    ...
    <div className="min-h-screen bg-[#0a0a0a] p-4 md:p-6">
      ...
      <div className="mb-6">
        <div className="flex items-center text-sm">
          <Link href="/dashboard" className="text-gray-500 hover:text-cyan-400">Dashboard</Link>
          <ChevronRight className="h-4 w-4 mx-2 text-gray-600" />
          <Link href="/dashboard/loans" className="text-gray-500 hover:text-cyan-400">Loans</Link>
          <ChevronRight className="h-4 w-4 mx-2 text-gray-600" />
      ...
      {!showForm && (
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#111111] rounded-xl border border-gray-800 overflow-hidden">
            {/* Header Banner */}
            <div className="bg-gradient-to-r from-cyan-900 to-cyan-700 p-8 text-center">
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-[#0a0a0a] rounded-lg p-4 flex items-start">
                    <Percent className="h-5 w-5 text-cyan-400 mr-3 mt-0.5" />
                    <div>
                  ...
                  <div className="bg-[#0a0a0a] rounded-lg p-4 flex items-start">
                    <FileText className="h-5 w-5 text-cyan-400 mr-3 mt-0.5" />
                    <div>
                  ...
                  <div className="bg-[#0a0a0a] rounded-lg p-4 flex items-start">
                    <Shield className="h-5 w-5 text-cyan-400 mr-3 mt-0.5" />
                    <div>
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {LOAN_TYPES.map((type) => {
                    ...
                    return (
                      <div key={type.id} className="bg-[#0a0a0a] border border-gray-800 rounded-lg p-4 hover:border-cyan-500/50 transition-colors">
              ...
              <div className="mb-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="w-8 h-8 rounded-full bg-cyan-500/10 flex items-center justify-center mr-4 shrink-0">
      ...
      {showForm && !hasActiveLoan && (
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#111111] rounded-xl border border-gray-800 overflow-hidden">
            {/* Header */}
            <div className="bg-gradient-to-r from-cyan-900 to-cyan-700 p-6">
            ...
            <form onSubmit={handleSubmit} className="p-6 md:p-8">
              {/* Back Button */}
              <button type="button" onClick={() => setShowForm(false)} className="flex items-center text-gray-400 hover:text-cyan-400 mb-6">
                ...
                <div className="bg-[#0a0a0a] rounded-xl border border-gray-800 p-5 space-y-5">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-4 py-2.5 bg-[#111111] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-cyan-500"
                          required
                        />
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <select
                          ...
                          onChange={handleInputChange}
                          className="w-full pl-10 pr-4 py-2.5 bg-[#111111] border border-gray-700 rounded-lg text-white appearance-none focus:outline-none focus:ring-2 focus:ring-cyan-500"
                          required
                        >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className="w-full px-4 py-2.5 bg-[#111111] border border-gray-700 rounded-lg text-white appearance-none focus:outline-none focus:ring-2 focus:ring-cyan-500"
                    >
              ...
              {formData.amount && parseFloat(formData.amount) > 0 && (
                <div className="mb-8 bg-cyan-500/10 border border-cyan-500/30 rounded-xl p-5">
              ...
              <div className="mb-6">
                <label className="flex items-start cursor-pointer">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="mt-1 h-4 w-4 rounded border-gray-600 bg-gray-800 text-cyan-500 focus:ring-cyan-500"
                  />
                  <span className="ml-3 text-sm text-gray-300">
                    I agree to the <Link href="#" className="text-cyan-400 hover:underline">Terms and Conditions</Link> and understand that my application will be reviewed.
                  </span>
                </label>
              </div>
              ...
              <button
                ...
                className="w-full py-3 rounded-lg bg-cyan-600 hover:bg-cyan-700 disabled:bg-cyan-600/50 text-white font-medium flex items-center justify-center transition-colors"
              >
                {isSubmitting ? (
