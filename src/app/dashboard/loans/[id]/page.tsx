    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/dashboard/loans" className="text-cyan-400 hover:text-cyan-300 mt-2 inline-block">
            Back to Loans
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#0a0a0a] p-4 md:p-6">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <Link href="/dashboard/loans" className="flex items-center text-gray-400 hover:text-cyan-400">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-[#111111] rounded-xl border border-gray-800 p-6">
            <h3 className="text-lg font-medium text-white mb-4" style={{color: "white"}}>
              <FileText className="h-5 w-5 inline mr-2 text-cyan-400" />
              Loan Purpose
            </h3>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#111111] rounded-xl border border-gray-800 p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <div className="w-8 h-8 rounded-full bg-cyan-500/20 flex items-center justify-center mr-3 shrink-0">
