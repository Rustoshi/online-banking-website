...
export default function KycPage() {
  ...
  if (isLoading) return <div className="min-h-screen flex items-center justify-center"><Loader2 className="h-8 w-8 animate-spin text-cyan-500" /></div>;
    ...
    return (
      <div className="min-h-screen bg-[#0a0a0a] p-4 md:p-6">
        ...
        <div className="bg-[#111111] rounded-xl border border-gray-800 p-8 text-center max-w-2xl mx-auto">
          ...
          <Link href="/dashboard" className="inline-flex items-center px-6 py-3 rounded-lg bg-cyan-600 hover:bg-cyan-700 text-white font-medium">Back to Dashboard</Link>
        </div>
      </div>
    );
  }
      ...
      <div className="bg-[#111111] rounded-xl border border-gray-800 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4">
              {DOCUMENT_TYPES.map((doc) => {
                const Icon = doc.icon;
                return (
                  <label key={doc.id} className={`flex flex-col items-center p-4 rounded-lg border cursor-pointer ${documentType === doc.id ? 'border-cyan-500 bg-cyan-500/10' : 'border-gray-700'}`}>
                    ...
                    <Icon className={`h-6 w-6 mb-2 ${documentType === doc.id ? 'text-cyan-400' : 'text-gray-400'}`} />
          ...
          <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-4">
            <div className="flex"><Info className="h-5 w-5 text-cyan-400 shrink-0" />
          ...
          <div>
            ...
            <div className={`border-2 border-dashed rounded-lg p-6 text-center ${frontImage ? 'border-cyan-500' : 'border-gray-700'}`}>
          ...
          <div>
            ...
            <div className={`border-2 border-dashed rounded-lg p-6 text-center ${backImage ? 'border-cyan-500' : 'border-gray-700'}`}>
          ...
          <div>
            ...
            <div className={`border-2 border-dashed rounded-lg p-6 text-center ${selfieImage ? 'border-cyan-500' : 'border-gray-700'}`}>
          ...
          {/* Submit */}
          <button type="submit" disabled={isSubmitting} className="w-full py-3 rounded-lg bg-cyan-600 hover:bg-cyan-700 disabled:bg-cyan-600/50 text-white font-medium flex items-center justify-center">
