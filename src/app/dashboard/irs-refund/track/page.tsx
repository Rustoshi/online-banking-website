          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              ...
              <div className="relative flex items-start">
                <div className="absolute left-0 w-8 h-8 rounded-full bg-cyan-500/20 flex items-center justify-center z-10">
              ...
              {['approved', 'processed'].includes(refund.status) && (
                <div className="relative flex items-start">
                  <div className={`absolute left-0 w-8 h-8 rounded-full flex items-center justify-center z-10 ${
                    refund.status === 'processed' ? 'bg-green-500/20' : 'bg-cyan-500/20'
                  }`}>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="inline-flex items-center px-4 py-2 rounded-lg bg-cyan-600 hover:bg-cyan-700 text-white transition-colors"
              >
