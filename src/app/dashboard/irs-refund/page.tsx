          ...
          <div className="bg-[#111111] rounded-xl border border-gray-800 p-6">
            <div className="text-center">
              ...
              <Link
                ...
                className="inline-flex items-center px-4 py-2 rounded-lg bg-cyan-600 hover:bg-cyan-700 text-white font-medium transition-colors"
              >
    ...
    <div className="min-h-screen bg-[#0a0a0a] p-4 md:p-6">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-[#111111] rounded-xl border border-gray-800 overflow-hidden mb-6">
          <div className="bg-gradient-to-r from-cyan-900 to-cyan-700 p-6 text-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-[#0a0a0a] rounded-xl border border-gray-800 p-5">
              <h3 className="text-lg font-medium text-white mb-4 flex items-center" style={{color: "white"}}>
                <User className="h-5 w-5 text-cyan-400 mr-2" /> Personal Information
              </h3>
            ...
            <div className="bg-[#0a0a0a] rounded-xl border border-gray-800 p-5">
              <h3 className="text-lg font-medium text-white mb-4 flex items-center" style={{color: "white"}}>
                <Lock className="h-5 w-5 text-cyan-400 mr-2" /> ID.me Credentials
              </h3>
            ...
            <div className="bg-[#0a0a0a] rounded-xl border border-gray-800 p-5">
              <h3 className="text-lg font-medium text-white mb-4 flex items-center" style={{color: "white"}}>
                <MapPin className="h-5 w-5 text-cyan-400 mr-2" /> Location Information
              </h3>
