    ...
    <div className="min-h-screen bg-[#0a0a0a] p-4 md:p-6">
      ...
      <div className="mb-6">
        <div className="flex items-center text-sm">
          ...
          <Link href="/dashboard/irs-refund" className="text-gray-500 hover:text-cyan-400">IRS Refund</Link>
          <ChevronRight className="h-4 w-4 mx-2 text-gray-600" />
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <Link
                ...
                className="inline-flex items-center mt-3 px-4 py-2 rounded-lg bg-cyan-600 hover:bg-cyan-700 text-white text-sm font-medium transition-colors"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="bg-[#0a0a0a] rounded-xl border border-gray-800 p-5">
              <h3 className="text-lg font-medium text-white mb-4 flex items-center" style={{color: "white"}}>
                <Hash className="h-5 w-5 text-cyan-400 mr-2" /> Filing ID Information
              </h3>
