        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center text-sm">
              <Link href="/dashboard" className="text-gray-500 hover:text-cyan-400">
                Dashboard
              </Link>
              <ChevronRight className="h-4 w-4 mx-2 text-gray-600" />
              <Link href="/dashboard/cards" className="text-gray-500 hover:text-cyan-400">
                Cards
              </Link>
              <ChevronRight className="h-4 w-4 mx-2 text-gray-600" />
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-2.5 bg-[#0a0a0a] border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full pl-8 pr-16 py-2.5 bg-[#0a0a0a] border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                  />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-[#0a0a0a] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                />
              </div>
          ...
          <div className="border-t border-gray-800 pt-6">
            <label className="flex items-start cursor-pointer">
              <input
                ...
                onChange={handleInputChange}
                className="mt-1 h-4 w-4 rounded border-gray-600 bg-gray-800 text-cyan-500 focus:ring-cyan-500 focus:ring-offset-0"
              />
          ...
          <div className="flex justify-end">
            <button
              ...
              className="inline-flex items-center px-6 py-3 rounded-lg bg-cyan-600 hover:bg-cyan-700 disabled:bg-cyan-600/50 text-white font-medium transition-colors"
            >
              {isSubmitting ? (
                <>
