...
export default function CardsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] p-4 md:p-6">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          ...
          <Link
            ...
            className="inline-flex items-center px-4 py-2 rounded-lg bg-cyan-600 hover:bg-cyan-700 text-white text-sm font-medium transition-colors"
          >
      ...
      {/* Info Box */}
      <div className="bg-gradient-to-r from-cyan-900/50 to-cyan-800/30 rounded-xl overflow-hidden border border-cyan-800/50 mb-6">
        <div className="md:flex">
          <div className="p-6 md:flex-1">
            ...
            <div className="mt-6">
              <Link
                href="/dashboard/cards/apply"
                className="inline-flex items-center px-4 py-2 rounded-lg bg-white text-cyan-900 text-sm font-medium hover:bg-gray-100 transition-colors"
              >
                Apply Now
              </Link>
            </div>  
          ...
          <div className="hidden md:flex md:items-center md:justify-center md:w-1/3 p-6">
            <div className="relative w-48 h-32">
              ...
              <div className="absolute w-full h-full rounded-xl bg-gradient-to-r from-cyan-800 to-cyan-600 shadow-lg">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-[#111111] rounded-xl border border-gray-800 p-6">
            <div className="flex items-center justify-center h-12 w-12 rounded-full bg-cyan-500/10 mb-4">
              <CreditCard className="h-6 w-6 text-cyan-400" />
            </div>
