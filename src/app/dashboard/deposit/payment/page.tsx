    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex flex-col mb-6">
        ...
        <div className="flex items-center text-sm" style={{color: "#9ca3af"}}>
          ...
          <Link href="/dashboard/deposit" className="hover:text-cyan-400">Deposits</Link>
          <ChevronRight className="h-4 w-4 mx-2" />
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <div
                ...
                className="border-2 border-dashed border-gray-600 rounded-lg p-6 text-center hover:border-cyan-500 transition-all cursor-pointer"
                style={{backgroundColor: 'rgb(55 65 81)'}}
              >
                {!proofFile ? (
