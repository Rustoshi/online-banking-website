                      ...
                      >
                        <div className="flex items-center">
                          ...
                          <div className={`w-5 h-5 border rounded-full flex items-center justify-center ${
                            selectedMethod === method._id ? 'bg-cyan-500 border-cyan-500' : 'border-gray-500'
                          }`}>
              ...
              <div className="mb-8 p-5 rounded-xl border border-gray-600" style={{backgroundColor: 'rgb(55 65 81)'}}>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    min="1"
                    step="any"
                    className="block w-full pl-12 pr-20 py-4 border-2 border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all text-2xl font-bold"
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {QUICK_AMOUNTS.map((quickAmount) => (
                    <button
                      ...
                      className="px-4 py-2 rounded-md text-sm font-medium transition-colors border border-gray-600 hover:border-cyan-500 hover:bg-cyan-500/10"
