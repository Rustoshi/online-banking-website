    ...
    <div className="min-h-screen bg-[#0a0a0a] p-4 md:p-6">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center text-sm mt-1">
          ...
          <Link href="/dashboard/profile" className="text-gray-500 hover:text-cyan-400">Settings</Link>
          <ChevronRight className="h-4 w-4 mx-2 text-gray-600" />
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-3 bg-[#0a0a0a] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-cyan-500"
                    required
                  />
                  <button
                    type="button"
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-4">
                ...
                <ul className="space-y-2">
                  <li className="flex items-center text-sm text-gray-400">
                    <div className="h-2 w-2 bg-cyan-500 rounded-full mr-3"></div>
