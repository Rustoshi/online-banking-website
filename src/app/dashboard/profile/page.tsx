      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4">
          <div className="bg-[#111111] rounded-xl border border-gray-800 overflow-hidden mb-6">
            {/* Profile Header */}
            <div className="relative bg-gradient-to-r from-cyan-900 to-cyan-700 px-6 py-8 flex flex-col items-center">
              {/* Profile Photo */}
              <div className="relative mb-3">
                <div className="h-24 w-24 rounded-full border-4 border-white/30 overflow-hidden bg-gray-700 shadow-lg">
                  {user?.profilePhoto ? (
                    ...
                    <div className="h-full w-full flex items-center justify-center text-2xl font-bold text-white bg-cyan-600">
            ...
            <div className="p-4">
              <nav className="space-y-1">
                <Link
                  ...
                  className="flex items-center px-4 py-3 rounded-lg bg-cyan-500/10 text-white font-medium"
                >
          ...
          <div className="relative bg-[#111111] rounded-xl border border-gray-800 w-full max-w-md p-6">
            ...
            <div className="space-y-5">
              ...
              <button
                ...
                className="w-full py-3 rounded-lg bg-cyan-600 hover:bg-cyan-700 disabled:bg-cyan-600/50 text-white font-medium flex items-center justify-center"
              >
                {isUploadingPhoto ? (
