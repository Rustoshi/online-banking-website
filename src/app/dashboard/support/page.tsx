        ...
        <div className="bg-[#111111] rounded-xl border border-gray-800 overflow-hidden mb-6">
          ...
          <div className="border-b border-gray-800 px-6 py-4">
            <h2 className="text-xl font-semibold text-white flex items-center" style={{color: "white"}}>
              <LifeBuoy className="h-5 w-5 mr-2 text-cyan-400" />
          ...
          <div className="flex justify-center py-8">
            <div className="h-24 w-24 rounded-full bg-cyan-500/10 flex items-center justify-center">
              <MessageCircleQuestion className="h-12 w-12 text-cyan-400" />
            </div>
          </div>
          ...
          <div className="p-6 pt-0">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    maxLength={200}
                    className="w-full pl-10 pr-4 py-3 bg-[#0a0a0a] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-cyan-500"
                    required
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className="w-full pl-10 pr-10 py-3 bg-[#0a0a0a] border border-gray-700 rounded-lg text-white appearance-none focus:outline-none focus:ring-2 focus:ring-cyan-500"
                  >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-[#0a0a0a] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 resize-none"
                    required
                  />
                </div>
              ...
              <button
                ...
                className="w-full md:w-auto px-6 py-3 rounded-lg bg-cyan-600 hover:bg-cyan-700 disabled:bg-cyan-600/50 text-white font-medium flex items-center justify-center"
              >
                {isSubmitting ? (
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-[#111111] rounded-xl border border-gray-800 p-5">
            <div className="flex items-center mb-3">
              ...
              <h3 className="text-lg font-semibold text-white" style={{color: "white"}}>FAQ</h3>
            </div>
            <p className="text-sm text-gray-400 mb-4">
              Find answers to commonly asked questions in our help center.
            </p>
            <Link href="/dashboard/faq" className="inline-flex items-center text-cyan-400 hover:text-cyan-300 text-sm font-medium">
              View FAQ <ExternalLink className="h-4 w-4 ml-1" />
            </Link>
          </div>
        </div>
      </div>
